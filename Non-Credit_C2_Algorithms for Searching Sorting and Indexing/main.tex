...
main disadvantage is that it may have false positives, due to the approximaty nature. How? Let`s find out latter.\\
Here is the basic idea of Bloom Filters. We will use $k$ randomly choosen hash functions to hash the key into $m$ slots.\\
...
a.k.a. $h_1(x), h_2(x), \ldots, h_k(x)$, and see if all the slots are set.\\}
